...
function TrustSection() {
  const items = [
    { title: "Koleksi Berkualitas", sub: "Temukan item pilihan dan unik.",            color: "bg-emerald-500/15 text-emerald-600 dark:text-emerald-400", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> },
